...
const MailsSubscriptionCard = () => {
  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 bg-dark-secondary drop-shadow-2xl rounded-2xl overflow-hidden">
      ...
      <form
        noValidate
        className="flex flex-col col-span-1 justify-center gap-5 p-10 sm:p-32 md:p-20 lg:p-28 xl:p-32"
